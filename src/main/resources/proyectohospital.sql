...
--
DROP DATABASE IF EXISTS `proyectohospital`;
...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `users` (SOLO 5 USUARIOS)
--
...
--
-- Volcado de datos para la tabla `users` (5 usuarios)
--

INSERT INTO `users` (`id`, `email`, `estado`, `nombre`, `password`, `rol`, `telefono`) VALUES
(1, 'admin@gmail.com', 'true', 'admin', 'admin', 'admin', '765432176'),
(2, 'laura@gmail.com', 'true', 'laura', 'usuario', 'user', '823456788'),
(3, 'carlos@gmail.com', 'true', 'carlos', 'usuario', 'user', '654321987'),
(4, 'ana@gmail.com', 'true', 'ana', 'usuario', 'user', '712345678'),
(5, 'jose@gmail.com', 'true', 'jose', 'usuario', 'user', '654321765');
...
(1, '2024-05-29 19:30:00.000000', '19:30:00', 6, 25, 2),
(2, '2024-05-30 15:00:00.000000', '15:00:00', 5, 6, 2),
(15, '2024-06-04 11:00:00.000000', '11:00:00', 4, 10, 5);
